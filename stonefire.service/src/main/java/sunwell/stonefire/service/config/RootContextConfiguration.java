...
@EnableJpaRepositories(
        basePackages = "sunwell.stonefire.base.repo",
...
@ComponentScan(
        basePackages = "sunwell.stonefire.base",
        excludeFilters =
        ...
        AsyncConfigurer, SchedulingConfigurer
{
    ...
    public Jaxb2Marshaller jaxb2Marshaller()
    {
        ...
        marshaller.setPackagesToScan(new String[] { "sunwell.pos.model" });
        return marshaller;
    }
    ...
    public DataSource springJpaDataSource()
    {
        ...
        return lookup.getDataSource("java:app/stonefire_db");
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean()
    {
        try {
	        ...
	        factory.setPackagesToScan("sunwell.stonefire.core.entity");
